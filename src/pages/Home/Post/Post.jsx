...
const Post = () => {
    ...
    return (
        <form onSubmit={handlePostValue} className='flex relative flex-col lg:mx-10 my-10 lg:my-0'>
            <textarea name='post' class="w-96 lg:w-full h-64 rounded-md shadow-md p-4 resize-none leading-tight focus:outline-none focus:shadow-outline-blue-500 bg-base-300" placeholder="Enter your input here...">
            </textarea>
